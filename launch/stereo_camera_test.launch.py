# -*- coding: utf-8 -*-
# depthai_ros_my/launch/stereo_camera_test.launch.py
#
...
# $ ros2 launch depthai_ros_my stereo_camera_test.launch.py mode:=disparity
#
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='stereo_camera_test',
            name='stereo_camera_test',
            output="screen",
