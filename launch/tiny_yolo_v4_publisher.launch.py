# -*- coding: utf-8 -*-
#  depthai_ros_my/launch/tiny_yolo_v4_publisher.launch.py
#
# org
...
#
# 2. run
# $ ros2 launch depthai_ros_my tiny_yolo_v4_publisher.launch.py
#
...
def generate_launch_description():
    ...
    nnName            = LaunchConfiguration('nnName', default = "best_openvino_2022.1_6shave.blob")
    nnJson            = LaunchConfiguration('nnJson', default = "best.json")
    ...
    mobilenet_node = launch_ros.actions.Node(
            package='depthai_ros_my', executable='tiny_yolo_v4_publisher',
            output='screen',
